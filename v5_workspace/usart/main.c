...
//   USART_Tx( USART0, buffer );
   switch(buffer)
   {
     case 1: GPIO_PinOutToggle(BSP_GPIO_LED0_PORT,BSP_GPIO_LED0_PIN); break;
     case 2: GPIO_PinOutToggle(BSP_GPIO_LED1_PORT,BSP_GPIO_LED1_PIN); break;
     case 3:
       {
         GPIO_PinOutToggle(BSP_GPIO_LED0_PORT,BSP_GPIO_LED0_PIN);
         GPIO_PinOutToggle(BSP_GPIO_LED1_PORT,BSP_GPIO_LED1_PIN); break;
       }
   case 4: GPIO_PinOutClear(BSP_GPIO_LED0_PORT,BSP_GPIO_LED0_PIN); break;
   case 5: GPIO_PinOutClear(BSP_GPIO_LED0_PORT,BSP_GPIO_LED1_PIN); break;
   case 6: {
     GPIO_PinOutClear(BSP_GPIO_LED0_PORT,BSP_GPIO_LED0_PIN);
     GPIO_PinOutClear(BSP_GPIO_LED1_PORT,BSP_GPIO_LED1_PIN); break;
   }
   }
